/**
 * サイドバーのリンクに関する定数
 * @type {Array<{ imgURL: string; route: string; label: string }>}
 */
...
/**
 * ポッドキャストデータに関する定数
 * @type {Array<{ id: number; title: string; description: string; imgURL: string }>}
 */
export const podcastData = [
  {
    id: 1,
    title: "ジョー・ローガン・エクスペリエンス",
    description: "長編の、詳細な会話",
    imgURL:
